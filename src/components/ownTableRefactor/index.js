...
class OwnTable extends Component {
     ...
     */
    drag = (event) => {
        event.dataTransfer.setData("sourceField", event.target.id);
    }
    ...
    drop = (event) => {
        ...
        let newOptionFields = _without(this.state.optionFields, field);
        let pivotingFields = _union(this.state[event.target.id], [field]);

        this.setState({
            loading: true,
            optionFields: newOptionFields,
                            ...
                            <td id="optionFields" className="option-fields">
                                {
                                    ...
                                    this.state.optionFields.map((field, index) =>
                                        <span id={field} key={field + 'option'} className="field-items" draggable="true"
